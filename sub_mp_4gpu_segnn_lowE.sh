...
IDENTIFIER=4_gpu_0.5_segnn_lowE
CONFIGPATH=/pscratch/sd/w/wenxu/jobs/OCP/ocp/configs/oc22/s2ef_mag/segnn/dpp_segnn_lowE.yml
LOGFILE=log_4gpu_0.5_segnn_lowE
NODES=4
